...
export default function WorkspaceApp() {
  ...
  return <div className="app-shell">
    ...
    <aside className={`sidebar ${sidebarOpen ? "sidebar-open" : ""}`}><button className="brand" onClick={() => navigate("office")} aria-label="GX Hub — início"><BrandMark size={43} /><span><strong>GX <b>HUB</b></strong><small>VIRTUAL WORKSPACE</small></span></button>
      ...
      {data.me.canAccessGroupSystem && <a className="group-system-button" href="https://gxhubuy.lovable.app/" target="_blank" rel="noopener noreferrer"><span className="group-system-icon"><Globe2 size={15} /></span><span><strong>Sistema Grupo X</strong><small>Área exclusiva</small></span><ArrowUpRight size={13} /></a>}
