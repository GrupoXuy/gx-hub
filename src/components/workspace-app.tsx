...
import { Building2, Video, Users, CalendarDays, ChevronRight, ChevronsUpDown, UserPlus, Search, Bell, CircleHelp, Menu, X, Clock3, UserRoundPen, Plus, Wifi, WifiOff, Settings2, Sparkles, Check, Info, PhoneOff, Maximize2, Headphones, ShieldCheck, LogOut } from "lucide-react";
...
export default function WorkspaceApp() {
  ...
  return <div className="app-shell">
    ...
    <aside className={`sidebar ${sidebarOpen ? "sidebar-open" : ""}`}><button className="brand" onClick={() => navigate("office")} aria-label="GX Hub — início"><BrandMark size={43} /><span><strong>GX <b>HUB</b></strong><small>VIRTUAL WORKSPACE</small></span></button>
      ...
      <EcosystemNav onExplore={() => setDialog({ type: "company" })} />
